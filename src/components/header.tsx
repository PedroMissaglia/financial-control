    ...
    <header role="banner" className="sticky top-0 z-50 border-b bg-white shadow-sm">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <Link
              href="/"
              className="flex items-center gap-2 rounded-md focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none"
                ...
                <nav className="hidden items-center gap-6 md:flex" aria-label="Navegação principal">
                  {navItems.map(item => (
                    <Link
                      ...
                      href={item.href}
                      className={cn(
                        'rounded-md px-2 py-1 font-medium transition-colors focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none',
