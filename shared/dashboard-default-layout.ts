...
export const DEFAULT_WIDGETS: DashboardWidget[] = [
  ...
  { id: 'tipo', visible: true, cols: 12, colStart: 1 },
  { id: 'forma', visible: true, cols: 12, colStart: 1 },
  { id: 'anual', visible: true, cols: 12, colStart: 1 },
  { id: 'compromissos', visible: true, cols: 12, colStart: 1 },
...
export function createDefaultDashboardLayout(): {
  ...
  return {
    ...
    layoutRows: [
      ...
      { type: 'full', widgetId: 'compromissos' },
      { type: 'full', widgetId: 'categorias' },
      { type: 'full', widgetId: 'tipo' },
      { type: 'full', widgetId: 'forma' },
